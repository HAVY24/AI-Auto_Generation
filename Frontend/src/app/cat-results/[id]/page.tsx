...
export default function ResultsPage() {
  ...
  const hasApplicationQuestions = results.some((r: any) => {
      ...
      <main className="container py-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Link href={`/exam-adaptive?subject=${session.subject_id}&numQuestions=${session.total_questions}&autoStart=true`}>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {Object.entries(topic_scores).map(([name, score]: [string, any]) => {
